//week03_06_processing_NS_SHAFT_03_spike_triangle_rolling_frameCount_MOD
//修改至week03_05_processing_NS_SHAFT_02_draw_floor
//小朋友下樓梯 現在加上上方尖刺+轉動
void setup(){
  size(600,600);//小朋友截YouTube圖片，得到大小
...
void draw(){
  ...
  for (int i=0;i<20;i++){
    ...
    rect(floorX[i],75+i*75-frameCount,140,25);//y座標一直減(往上捲)
